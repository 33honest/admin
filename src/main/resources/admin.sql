...
insert  into `sys_role`(`role_id`,`role_name`,`role_desc`,`rights`,`add_qx`,`del_qx`,`edit_qx`,`query_qx`,`user_id`,`create_time`) values (1,'管理员','管理员权限','1267650600228229401496703205375','1','1','126','126','1','2017-09-12 15:38:56'),(2,'tyro','随便创建的随便创建的随便创建的随便创建的随便创建的随便创建的随便创建的随便创建的随便创建的随便创建的','94','2','1','4','126','1','2017-09-12 15:44:06'),(3,'test','是测试角色这个是测试角色这个是测试角色这个是测试角色这个是测试角色','382','382','382','382','126','1','2017-09-12 15:39:28'),(4,'查看','可以查看所有的东西','126','0','0','0','126','1','2017-09-14 17:17:17');
...
insert  into `sys_user`(`user_id`,`username`,`nick_name`,`password`,`pic_path`,`status`,`create_time`) values (1,'admin','管理员','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','http://www.lrshuai.top/upload/user/20170612/05976238.png','unlock','2017-08-18 13:57:32'),(2,'tyro','tyro','481c63e8b904bb8399f1fc1dfdb77cb40842eb6f','/upload/show/user/82197046.png','unlock','2017-09-12 14:03:39'),(3,'asdf','asdf','3da541559918a808c2402bba5012f6c60b27661c','/upload/show/user/85610497.png','unlock','2017-09-13 14:49:10'),(13,'nathan','nath','77bce9fb18f977ea576bbcd143b2b521073f0cd6','/upload/show/user/82409756.png','unlock','2018-05-30 13:41:20'),(15,'nathaaacc','南京','e0c9035898dd52fc65c41454cec9c4d2611bfb37','/images/logo.png','unlock',NULL),(16,'root','linxuroot','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','/images/logo.png','unlock','2018-06-14 11:04:27'),(17,'abc','aa','86f7e437faa5a7fce15d1ddcb9eaeaea377667b8','/images/logo.png','unlock','2018-06-14 11:05:32'),(19,'test','测试账号','a94a8fe5ccb19ba61c4c0873d391e987982fbbd3','/images/logo.png','lock','2018-06-14 11:08:51');
